...
bool recoloc(pom::RecolocService::Request  &req, pom::RecolocService::Response &res) {
//    int start = cv::getTickCount();
    vector<int> object_numbers = detecter.process (curr_img, Ps, names); // MAIN CALL
    cout << "Sees " << object_numbers.size() << " known objects." << endl;
    res.object_numbers.data = object_numbers;
...
int main (int argc, char** argv) {
    ...
    ROS_INFO("Object recoloc service ready.");
    ros::spin();
